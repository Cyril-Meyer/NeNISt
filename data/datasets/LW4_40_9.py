...
train_labels_one_hot = np.load(DATA_FOLDER + "TRAIN_LW4_LABELS_ONE_HOT.npy")
...
valid_image_standardized_f16 = np.load(DATA_FOLDER + "VALID_LW4_IMAGE_STANDARDIZED_F16.npy")
...
valid_labels_one_hot = np.load(DATA_FOLDER + "VALID_LW4_LABELS_ONE_HOT.npy")
...
test_labels_one_hot = np.load(DATA_FOLDER + "TEST_LW4_LABELS_ONE_HOT.npy")
