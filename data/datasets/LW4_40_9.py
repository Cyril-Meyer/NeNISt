...
train_lw4_label_4 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_4.npy")
train_lw4_label_5 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_5.npy")
train_lw4_label_6 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_6.npy")
train_lw4_label_7 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_7.npy")
train_lw4_label_8 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_8.npy")
train_lw4_label_9 = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_9.npy")
...
train_lw4_label_4_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_4_INDEXES.npy")
train_lw4_label_5_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_5_INDEXES.npy")
train_lw4_label_6_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_6_INDEXES.npy")
train_lw4_label_7_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_7_INDEXES.npy")
train_lw4_label_8_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_8_INDEXES.npy")
train_lw4_label_9_indexes = np.load(DATA_FOLDER + "TRAIN_LW4_LABEL_9_INDEXES.npy")
...
valid_lw4_label_4 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_4.npy")
valid_lw4_label_5 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_5.npy")
valid_lw4_label_6 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_6.npy")
valid_lw4_label_7 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_7.npy")
valid_lw4_label_8 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_8.npy")
valid_lw4_label_9 = np.load(DATA_FOLDER + "VALID_LW4_LABEL_9.npy")
...
valid_lw4_label_4_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_4_INDEXES.npy")
valid_lw4_label_5_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_5_INDEXES.npy")
valid_lw4_label_6_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_6_INDEXES.npy")
valid_lw4_label_7_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_7_INDEXES.npy")
valid_lw4_label_8_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_8_INDEXES.npy")
valid_lw4_label_9_indexes = np.load(DATA_FOLDER + "VALID_LW4_LABEL_9_INDEXES.npy")
...
test_lw4_label_4 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_4.npy")
test_lw4_label_5 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_5.npy")
test_lw4_label_6 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_6.npy")
test_lw4_label_7 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_7.npy")
test_lw4_label_8 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_8.npy")
test_lw4_label_9 = np.load(DATA_FOLDER + "TEST_LW4_LABEL_9.npy")
...
test_lw4_label_4_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_4_INDEXES.npy")
test_lw4_label_5_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_5_INDEXES.npy")
test_lw4_label_6_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_6_INDEXES.npy")
test_lw4_label_7_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_7_INDEXES.npy")
test_lw4_label_8_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_8_INDEXES.npy")
test_lw4_label_9_indexes = np.load(DATA_FOLDER + "TEST_LW4_LABEL_9_INDEXES.npy")
