...
def gen_patches_batch_augmented_2d(patch_size_y, patch_size_x, n_classes, image, label, batch_size=32, weights=None):
    batch_image = np.zeros((batch_size, patch_size_y, patch_size_x, 1), dtype=image.dtype)
    batch_label = np.zeros((batch_size, patch_size_y, patch_size_x, n_classes), dtype=np.float32)
